...
export const reserve = async (
    ...
    try {
        ...
        const { productId, quantity } = reserveSchema.parse(body);
...
export const checkout = async (
    ...
    try {
        ...
        const order = await ReservationService.checkoutReservation(
            req.userId!,
            reservationId
        );
...
export const getMyReservations = async (
    ...
    try {
        ...
        const { page, limit, status, sortOrder } = paginationSchema.parse(query);
